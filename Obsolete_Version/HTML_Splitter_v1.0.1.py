...
<script>function toggleblacktheme(){document.body.style.color =  "white";document.body.style.backgroundColor =  "black";}</script>
<script>function togglenormaltheme(){document.body.style.color =  "black";document.body.style.backgroundColor =  "#F6F3E9";}</script>
"""
