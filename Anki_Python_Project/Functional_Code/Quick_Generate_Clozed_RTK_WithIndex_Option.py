...
generateIndexedClozedRTK_key = 'i'
##########################################################################
...
def GenerateReIndexedClozedRTK(nids):
...
def newKeyHandler(self, evt):
    ...
    elif key == generateIndexedClozedRTK_key:
        #showInfo ("Found note: %s" % (self.card.note().id))
        GenerateReIndexedClozedRTK([self.card.note().id])
        tooltip(_("Indexed Note Cloze Generated"))
    else:
