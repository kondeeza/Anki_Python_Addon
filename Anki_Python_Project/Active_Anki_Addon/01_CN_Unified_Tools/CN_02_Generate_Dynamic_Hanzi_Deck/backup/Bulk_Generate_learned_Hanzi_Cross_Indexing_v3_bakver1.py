...
def reload_config():
    ...
    global Optional_Custom_MasterSlaveSyncFieldList
    ...
    Optional_Custom_MasterSlaveSyncFieldList = config['12_Optional_Custom_MasterSlaveSyncFieldList']
            ...
            for x in note[src_slave_Sentence]:
               if x in HanziOfHanziFreqList:
                    if x not in Slave_Hanzi_Dict:
                        Slave_Hanzi_Dict[x] = [[note[src_slave_Sentence],note[mSlaveList[2]],note[mSlaveList[3]],note[mSlaveList[4]],note[mSlaveList[5]]]]
                        info_Slave_Hanzi_indexed += 1
                    else: 
                        Slave_Hanzi_Dict[x].append([note[src_slave_Sentence],note[mSlaveList[2]],note[mSlaveList[3]],note[mSlaveList[4]],note[mSlaveList[5]]])
                        info_Slave_Hanzi_indexed += 1
               else:
