    ...
    for nid in nids:
        ...
        try:
            ...
            if Fuzzy_Character_Mode_Enabled == False:
                ...
                mAllToneInput_List = list(set(mAllToneInput_List)) #remove duplicate
