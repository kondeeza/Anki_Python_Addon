...
def reload_config():
    ...
    HanziDeck_modelName = config['04_1_HanziDeck_modelName']
    HanziDeck_Input_HanziField = config['04_2_HanziDeck_Input_HanziField']
    HanziDeck_Output_SrcField = config['04_3_HanziDeck_Output_SrcField']
...
def setupMenu(browser):
    ...
    menu.addSeparator()
    a = menu.addAction('CN Add_Hanzi_Vocabs_List_To_My_Hanzi_Characters_Deck')
